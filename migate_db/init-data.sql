...
INSERT INTO public."user"(
	...
	VALUES (1, 'admin', '$2a$10$gyV1hkPk0gBYur0bTXxkaee3.d.CDEDdLfN5SOPUDHAeZOF57IUQa', 'administrator', now(), 'admin@test.com', '0943434', 'Address', 1, now(), 1, now());

INSERT INTO public."user"(
	user_id, user_name, password, name, date_of_birth, mail, phone, address, created_by, created_date, updated_by, updated_date)
	VALUES (2, 'teacher', '$2a$10$gyV1hkPk0gBYur0bTXxkaee3.d.CDEDdLfN5SOPUDHAeZOF57IUQa', 'teacher', now(), 'teacher@test.com', '0943434', 'Address', 1, now(), 1, now());

INSERT INTO public."user"(
	user_id, user_name, password, name, date_of_birth, mail, phone, address, created_by, created_date, updated_by, updated_date)
	VALUES (3, 'parent', '$2a$10$gyV1hkPk0gBYur0bTXxkaee3.d.CDEDdLfN5SOPUDHAeZOF57IUQa', 'parent', now(), 'parent@test.com', '0943434', 'Address', 1, now(), 1, now());
